...
export default function ViewProduct() {
 ...
 // const Plant = [
  // {title:" Tulips",availibility:10,description:"Tulips are spring-blooming perennial herbaceous bulbiferous geophytes in the Tulipa genus. Their flowers are usually large, showy, and brightly coloured, generally red, orange, pink, yellow, or white.",img:plant2},
  // {title:"Henna",description:"The term henna also refers to the dye made from the henna plant and the practice of temporary tattooing with those colours",img:plant1},
 //  {title:"Iris",description:"genus of about 300 species of flowering plants, including some of the world’s most popular and varied garden flowers.",img:plant3}
 // ];
